...
do {
//Menu
cout<<"\nOperations on list"<<endl;cout<<"1-Insert an element at front and end \n";
...
A.push_front(a);
A.push_back(b);
break;case 2: A.pop_front(); //To delete values from front and end
A.pop_back();
...
cout<<endl;
break;//To merge two listsand sort it
